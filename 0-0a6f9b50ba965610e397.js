  ...
  [0],
  {
    ...
    162: function(t, e, n) {
      ;(function(e) {
        ...
        var E,
          ...
          k = (E = /[^.]+$/.exec((F && F.keys && F.keys.IE_PROTO) || ''))
            ? 'Symbol(src)_1.' + E
            : '',
          ...
          Z = function(t) {
            return 'symbol' == typeof t || (X(t) && '[object Symbol]' == I(t))
          },
          tt = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,
          et = /^\w*$/,
          nt = function(t, e) {
        ...
        var gt = vt,
          ...
          xt = function(t) {
            return X(t) && '[object Arguments]' == I(t)
          },
          Lt = Object.prototype,
          ...
          Nt = xt(
            ...
            ? xt
            : function(t) {
                return X(t) && It.call(t, 'callee') && !Ct.call(t, 'callee')
              },
          Ft = function() {
            return !1
          },
                ...
                ;(s = c),
                  p || d || h
                    ? J(u)
                      ...
                      : (s = [])
                    : (function(t) {
                        if (!X(t) || '[object Object]' != I(t)) return !1
                        var e = le(t)
                        if (null === e) return !0
            ...
            !(function t(e, n, r, o, i) {
              e !== n &&
                Rt(
                  n,
                  function(a, u) {
                    if (C(a)) i || (i = new ne()), Te(e, n, u, r, t, o, i)
                    else {
              ...
              toJSON: function() {
                return (function(t, e) {
                  ...
                  ;(n = vn(n, 'html', {
                    ...
                    (n = vn(n, 'body', {
                      color: e.bodyColor,
                      fontFamily: e.bodyFontFamily.map(mn).join(','),
                  ...
                  ;(o = (function(t) {
                    ...
                    (n = vn(n, ['h1', 'h2', 'h3', 'h4', 'h5', 'h6'], {
                      color: e.headerColor,
                      fontFamily: e.headerFontFamily.map(mn).join(','),
      ...
      e.default = function() {
        return function(t, e) {
          var n = t.rhythm,
            a = void 0
          return (
            (a = (0, o.default)(e.blockMarginBottom)
              ? n(e.blockMarginBottom)
              : (0, i.default)(e.blockMarginBottom)
              ? e.blockMarginBottom
              : n(1)),
            {
              'tt,code': {
    ...
    164: function(t, e, n) {
      ...
      var c = {
        ...
        baseLineHeight: 1.56,
        googleFonts: [
          { name: 'Source Sans Pro', styles: ['200', '400', '400i', '700'] }
        ],
        scaleRatio: 2.5,
        ...
        overrideStyles: function(t, e) {
          ...
          return (
            (n = {
              'h1 a,h2 a,h3 a,h4 a,h5 a,h6 a': { fontWeight: e.headerWeight },
              a: { fontWeight: 400, color: '#419eda', textDecoration: 'none' },
              'a:hover': { color: '#2a6496', textDecoration: 'underline' },
              blockquote: r({}, l(0.2), {
                color: (0, o.default)(40),
                paddingLeft: s(0.75),
                marginLeft: 0,
                borderLeft: s(0.25) + ' solid ' + (0, o.default)(87)
              })
            }),
            (u = i.TABLET_MEDIA_QUERY),
            (c = {
              html: r({}, f.establishBaseline()),
              blockquote: {
                marginLeft: s(-0.75),
                marginRight: 0,
                paddingLeft: s(0.5)
      ...
      var r = n(181),
        ...
        c = function(t, e) {
          var n,
            o = r(e.baseFontSize),
            i = a(o(t, 'px')),
            u = a(e.baseLineHeightInPx),
            c = a(o(e.minLinePadding, 'px'))
          return (
            (n = e.roundToNearestHalfLine
              ? Math.ceil((2 * i) / u) / 2
              : Math.ceil(i / u)) *
              u -
              i <
              2 * c && (n += e.roundToNearestHalfLine ? 0.5 : 1),
            n
          )
        },
        l = function(t) {
          var e = r(t.baseFontSize)
          return function(n, r, o) {
            null == n && (n = 1),
              null == r && (r = t.baseFontSize),
              null == o && (o = 0)
            var u = n * a(t.baseLineHeightInPx) - o + 'px',
              c = e(u, t.rhythmUnit, r)
            return (
              'px' === i(c) && (c = Math.floor(a(c)) + i(c)),
              parseFloat(a(c).toFixed(5)) + i(c)
            )
          }
        }
      t.exports = function(t) {
                ...
                a(n.baseFontSize) * n.baseLineHeight + 'px'),
          {
            ...
            establishBaseline: function() {
              return (
                r((t = n).baseFontSize),
                {
                  fontSize: (a(t.baseFontSize) / 16) * 100 + '%',
                  lineHeight: t.baseLineHeight.toString()
                }
              )
              var t
            ...
            adjustFontSizeTo: function(t, e, o) {
              return (
                null == e && (e = 'auto'),
                (function(t, e, n, o) {
                  null == n && (n = o.baseFontSize),
                    '%' === i(t) &&
                      (t = a(o.baseFontSize) * (a(t) / 100) + 'px')
                  var u = r(o.baseFontSize)
                  t = u(t, 'px', (n = u(n, 'px')))
                  var s = l(o)
                  return (
                    'auto' === e && (e = c(t, o)),
                    { fontSize: u(t, o.rhythmUnit, n), lineHeight: s(e, n) }
                  )
                })(t, e, o, n)
              )
            }
    ...
    181: function(t, e, n) {
      ...
      t.exports = function(t) {
        return (
          null == t && (t = t),
          function(e, n, i, a) {
            null == i && (i = t), null == a && (a = i)
            var u = r(e)[1]
            if (u === n) return e
            var c = o(e)
            if ('px' !== u)
              if ('em' === u) c = o(e) * o(i)
              else if ('rem' === u) c = o(e) * o(t)
              else {
                if ('ex' !== u) return e
                c = o(e) * o(i) * 2
              }
    ...
    188: function(t, e, n) {
      ;(function(t) {
        ...
        var l,
          ...
          O = function(t, e) {
            void 0 !== t && document.title !== t && (document.title = A(t)),
...
//# sourceMappingURL=0-0a6f9b50ba965610e397.js.map
